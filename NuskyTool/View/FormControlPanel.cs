...
using NuskyTool.Classes.Settings;
...
namespace NuskyTool.Views {
	public partial class FormControlPanel : Form {
		...
		private void toggleServerState(bool isRunning, Button btn, PictureBox pb) {
			if(isRunning) {
				btn.BackgroundImage = NuskyTool.Properties.Resources.iconStopButton;
				pb.BackgroundImage  = NuskyTool.Properties.Resources.iconAdd;
			} else {
				btn.BackgroundImage = NuskyTool.Properties.Resources.iconPlayButton;
				pb.BackgroundImage  = NuskyTool.Properties.Resources.iconDelete;
			} 
		}
		...
		private void buttonPathDialog_Click(object sender, EventArgs e) {
			...
			ofd.Description = "Select the emulator Folder containing the .exe and .conf files!";
